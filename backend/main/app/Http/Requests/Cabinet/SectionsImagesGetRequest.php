...
/**
 * Class SectionsImagesGetRequest
 * @package App\Http\Requests\Cabinet
 */
class SectionsImagesGetRequest extends FormRequest
{
    /**
     * SectionsImagesGetRequest constructor.
     * @param array $query
     * @param array $request
    ...
    public function __construct(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        ...
        request()->merge(['gallery_id' => request()->route('gid')]);
        request()->request->remove('section_id');
        request()->merge(['section_id' => request()->route('sid')]);
