...
/**
 * Class DownloadGalleryRequest
 * @package App\Http\Requests\Web
 */
class DownloadGalleryRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'image_id.string' => 'id изображения не строка',
            'image_id.exists' => 'изображения с указанным id :input не существует',
            'image_type.in' => 'типа изображения должен быть: :values',
            'image_type.required_with' => 'типа изображения обязательно должен быть указан'
                . ' при скачивании одной фотографии',
