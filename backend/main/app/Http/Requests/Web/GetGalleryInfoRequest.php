...
/**
 * Class GetGalleryInfoRequest
 * @package App\Http\Requests\Web
 */
class GetGalleryInfoRequest extends FormRequest
{
    /**
     * GetGalleryInfoRequest constructor.
     * @param array $query
     * @param array $request
    ...
    public function messages(): array
    {
        return [
            ...
            'images.in' => 'значение флага включения изображений может быть только :values',
        ];
    }
}
